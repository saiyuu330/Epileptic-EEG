...
class ConvBlock(nn.Module):
    def __init__(self, ):
        ...
        self.depthwise = nn.Conv2d(16, 16, (19, 1), stride=1, padding=0, dilation=1, groups=16, bias=False)
...
class ATCNet(nn.Module):
    def __init__(self):
        ...
        for i in range(5):
            self.attention_list.append(AttentionBlock())
            self.TCN_list.append(TcnBlock())
        ...
        for i in range(n_windows):
            ...
            if fuse == 'average':
                ...
                if i == 0:
                    ...
                    sw_concat = torch.cat(sw_concat, block3)
...
class MyModel(nn.Module):
    def __init__(self):
        ...
        self.conv1 = nn.Sequential(
            nn.Conv2d(1, 16, (1, 64), stride=(1, 1), padding='same'),
            nn.BatchNorm2d(16),
            nn.GELU(),
            nn.Dropout(p=0.25),
            nn.Conv2d(16, 16, (19, 1)),
            nn.BatchNorm2d(16),
            nn.Dropout(p=0.25),
            nn.AvgPool2d(kernel_size=(1, 5)),
            nn.Dropout(p=0.25),
